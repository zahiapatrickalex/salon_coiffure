                ...
                <nav id="sidebarMenu" class="col-md-4 col-lg-3 d-md-block sidebar collapse p-0">
                    ...
                    <div class="position-sticky sidebar-sticky d-flex flex-column justify-content-center align-items-center">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_1">Profil</a>
                            </li>
                ...
                <div class="col-md-8 ms-sm-auto col-lg-9 p-0">
                    <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
                            ...
                            <div class="custom-block d-lg-flex flex-column justify-content-center align-items-center">
                                ...
                                <h4><strong class="text-white" style="font-size:20px;">dépeche-toi ! avoir une bonne coupe de cheveux.</strong></h4>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-12 mx-auto">
                                    <h2 class="mb-3">Obtenez 32% de réduction</h2>

                                    <p>toutes les deux semaines du mois</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12 mb-4">
                                    <div class="services-thumb">
                                        <img src="admins/images_bdd/<?=$row['img']?>" class="services-image img-fluid" alt="">
                                    ...
                                    <div class="booking-form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input type="text" name="nom" id="bb-name" class="form-control" placeholder="Nom et Prenom" required>
                                            </div>
                                ...
                                <div class="col-lg-8 col-12">
                                    <div class="price-list-thumb-wrap">
                                        <div class="mb-4">
                                            ...
                                            <strong>À partir de 1000 FCFA</strong>
							...
							<?php 
                                     ...
                                     ?>
											...
											<span class="price-list-thumb-divider"></span>
                                                ...
                                                <strong><?=$row['prixcoiffure']?> FCFA</strong>
                                            </h6>
                                            <?php 
                                          }
                                         ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    ...
                                    <p class="text-white d-flex">
                                        <a href="mailto:zpatrickalex@gmail.com" class="site-footer-link">
                                            hello@barber.beauty
                                        </a>
                                    </p>
                                ...
                                <div class="col-lg-5 col-12 contact-block-wrap mt-5 mt-lg-0 pt-4 pt-lg-0 mx-auto">
                                    <div class="contact-block">
                                        <h6 class="mb-0">
                                            ...
                                            <span class="ms-auto">08:00 H - 17:00 H</span>
                                        </h6>
                                    </div>
                                </div>
